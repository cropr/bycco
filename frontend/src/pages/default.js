...
if (process.env.NODE_ENV == 'development') {
  window.config.slug = 'toernooireglement';
  window.config.slugtemplates = JSON.parse('{"home": "default.html"}');
}

import {i18n} from '@/util/lang'
import store from '@/store/store_main'
import App from '@/pages/Default.vue'
import router from '@/views/router_default'
