...
const links = {
  BG8: "http://bycco.livechesscloud.com/view#/2274b3a0-a577-4c72-a077-8c1a31301402",
  ...
  BG18: "http://bycco.livechesscloud.com/view#/7bb06bdd-4a09-4e77-9980-e358b4611b15",
  BG20: "http://bycco.livechesscloud.com/view#/db5eea45-4bcf-47a8-8ca5-693de60dd396",
};
...
export default {
  ...
  computed: {
    ...
    link () {
      if (this.trn.shortname && this.trn.shortname in links) {
        return links[this.trn.shortname];
      }
      return '';
    },
  },
