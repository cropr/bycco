...
class DbAccount:
    ...
    def create_account(cls, account_in: dict ) -> str:
        ...
        try:
            db_conn[1][DbAccount.COLLECTION].insert_one(account_in)
    ...
    def find_account(cls, options: dict) -> dict:
        ...
        account = db_conn[1][cls.COLLECTION].find_one(options, 
    ...
    def update_account(cls, id: str, accountupdate: Dict[str, Any] ) -> dict:
        ...
        account = db_conn[1][cls.COLLECTION].find_one_and_update({'_id': oid}, 
    ...
    def set_password(cls, id: str, hashed_pwd: str) -> int:
        ...
        try:
            ...
            raise RdBadRequest(description="InvalidAccountId")
        rs = db_conn[1][cls.COLLECTION].update_one({'_id': oid}, {'$set':{
            'password': hashed_pwd
        }})
    ...
    def set_tokensalt(cls, username: str, tokensalt: str) -> int:
        ...
        """
        from ..common import db_conn
        rs = db_conn[1][cls.COLLECTION].update_one({'username': username}, {'$set':{
            'tokensalt': tokensalt
        }})
        return rs.modified_count
